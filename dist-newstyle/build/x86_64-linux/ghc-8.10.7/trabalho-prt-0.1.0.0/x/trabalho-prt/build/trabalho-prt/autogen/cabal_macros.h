...
/* package trabalho-prt-0.1.0.0 */
#ifndef VERSION_trabalho_prt
#define VERSION_trabalho_prt "0.1.0.0"
#endif /* VERSION_trabalho_prt */
#ifndef MIN_VERSION_trabalho_prt
#define MIN_VERSION_trabalho_prt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_trabalho_prt */
...
#define CURRENT_COMPONENT_ID "trabalho-prt-0.1.0.0-inplace-trabalho-prt"
